      ...
      <div className="relative z-10 flex-1 flex items-center px-8 sm:px-12 lg:px-20 py-16">
        <div className="max-w-3xl">
          ...
          <p className="animate-fade-up-delay-2 text-lg sm:text-xl text-white/80 leading-relaxed max-w-2xl mb-10">
            Sim2Real helps robotics teams turn simulation into a more reliable path to deployment, with scalable synthetic training data, sensor-consistent policy training, and fewer wasted hardware test cycles.
          </p>
